...
class CarControllerParams:
  STEER_MAX = 300
  # TODO-SP: these are per control step (STEER_STEP=2 -> 50 Hz).
  # safety/modes/byd.h uses max_rate_up/down = 17 per 100 ms safety tick.
  # 50 Hz * 100 ms = 5 steps, so per-step limits should be <= ~17/5 = 3.4
  # to exactly match the safety envelope. Revisit after real-world tuning.
  STEER_DELTA_UP = 7
  STEER_DELTA_DOWN = 10
